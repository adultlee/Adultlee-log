...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'f9ba054030974fecbf9315889a96fc1e',
  ...
  AUTHOR: 'devlsi1228', // 您的昵称 例如 tangly1024
  BIO: '게으른 코더', // 作者简介
  LINK: 'https://github.com/adultlee', // 网站地址
  KEYWORDS: 'Diary', // 网站关键词 英文逗号隔开
  ...
  COMMENT_VALINE_PLACEHOLDER:
    process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '입력해주세요~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
  ...
  TITLE: "Adult LEE's blog", // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE: '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    '낭만적인 하루를 보내기 위해 노력합니다. 그대의 삶에도 낭만이 가득하길', // 站点描述，被notion中的页面描述覆盖
